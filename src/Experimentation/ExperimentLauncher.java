 ...
 * implémenté dans la classe {@link compression.Archivage}.
 *
 * Elle permet :
...
public class ExperimentLauncher {
    ...
    private static final int[] SIZES = new int[]{
            1000, 10000, 100000, 500000, 1000000, 5000000//, 10000000, 25000000, 50000000, 75000000, 100000000
        ...
        try (BufferedWriter rawWriter = Files.newBufferedWriter(rawCsv)) {
            ...
            for (int size : SIZES) {
                ...
                for (int j = 0; j < FILES_PER_SIZE; j++) {
                    ...
                    // Fichier compressé
                    String compressed = input + ".bin";

                    // -----------------------------------------------------------------
                    //   COMPRESSION
                    // -----------------------------------------------------------------
                    Archivage arv = new Archivage(input, compressed);
